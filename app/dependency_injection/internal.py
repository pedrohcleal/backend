...
from app.controller.internal import BuscaDepartamentosController, BuscaColaboradoresController
...
class BuscaDepartamentosInjection:
    ...
    def new_busca_departamentos_controller(self) -> BuscaDepartamentosController:
        ...
        internal_controller: BuscaDepartamentosController = BuscaDepartamentosController(internal_usecase=internal_usecase)
...
class BuscaColaboradoresInjection:
    ...
    def new_busca_colaboradores(self) -> BuscaColaboradoresController:
        ...
        internal_controller: BuscaColaboradoresController = BuscaColaboradoresController(internal_usecase=internal_usecase)
        return internal_controller
