...
from app.dependency_injection.internal import BuscaDepartamentosInjection, BuscaColaboradoresInjection
...
def get_healthcheck() -> list[DepartamentoDTO]:
    with create_sqlite_conn() as sqlite_conn:
        ...
        internal_controller: BuscaDepartamentosController = internal_injection.new_busca_departamentos_controller()
